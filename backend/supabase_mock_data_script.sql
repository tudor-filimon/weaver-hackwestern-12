...
INSERT INTO nodes (
    ...
    (
        ...
        NULL,
        NULL,  -- NEW: context (will be populated when edges are created)
        'user',
        TRUE,
        FALSE,
        TRUE,
...
--     n.prompt as node_prompt,  -- CHANGED: was n.content
--     n.response as node_response,  -- NEW
